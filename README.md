...
Every layer — from a signed order to on-chain settlement, including the real chain backends — is built and tested (47 tests, typecheck clean). What's left is running it against live nodes (backends + PRL funding), not writing it.
