...
Every layer — from a signed order over a real WebSocket relay to on-chain settlement — is built, tested, and **proven live on real pearld nodes** (48 unit/integration tests + a live on-chain swap test, typecheck clean).
